            ...
            <div class="row">
              <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                  <a href="gen_maj_edit.php?id=<?php echo $id; ?>" class="btn btn-success"> <b class="mdi mdi-pencil-box"></b> Edit</a>
                </nav>
              </div>   
              ...
              <a href="gen_maj.php" class="btn btn-info"><i class="mdi mdi-keyboard-return"></i> Back Genre Major</a>
          </div>
