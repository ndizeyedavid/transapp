          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="page-header">
                <h3 class="page-title"> New Minor Genre </h3>
              </div>   
              ...
              <div class="col grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                      ...
                      <?php } ?>
                      <h4 class="card-title">Minor Genre</h4>
                      
                      <form class="forms-sample" action="php/gen_min_add.php" method="POST" enctype="multipart/form-data">
