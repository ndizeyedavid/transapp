          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="page-header">
                <h3 class="page-title"> Major Genres </h3>
                <nav aria-label="breadcrumb">
                  <a href="gen_maj_add.php" class="btn btn-success"> <b>+</b> New Genre</a>
                </nav>
              </div>   
              <?php  
              $new = "";
              ...
              $fetch = mysqli_query($con, "SELECT * FROM major_genre WHERE gen_id!='{$new}' ORDER BY release_date DESC");
              ...
              <div class="col-md-6 col-xl-4 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-footer" style="text-align: right;">
                    <div>
                      <a href="gen_maj_read.php?id=<?php echo $row['id']; ?>" class="btn btn-success btn-sm mdi mdi-newspaper" title="Read"></a>
                      <a href="gen_maj_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm mdi mdi-pencil-box" title='Edit'></a>
                      <a href="php/gen_maj_del.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm mdi mdi-delete-variant" title="Delete"></a>
                    </div>
                  </div>
                </div>
              </div>                        
              ...
              <?php  
              if (isset($_GET['new'])) {
                $fetch_new = mysqli_query($con, "SELECT * FROM major_genre WHERE gen_id='{$new}'");
              ...
              <div class="col-md-6 col-xl-4 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-footer" style="text-align: right;">
                    <div>
                      <a href="gen_maj_read.php?id=<?php echo $data['id']; ?>" class="btn btn-success btn-sm mdi mdi-newspaper" title="Read"></a>
                      <a href="gen_maj_edit.php?id=<?php echo $data['id']; ?>" class="btn btn-warning btn-sm mdi mdi-pencil-box" title='Edit'></a>
                      <a href="php/gen_maj_del.php?id=<?php echo $data['id']; ?>" class="btn btn-danger btn-sm mdi mdi-delete-variant" title="Delete"></a>
                    </div>
                  </div>
                </div>
              </div>
