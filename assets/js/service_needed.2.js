//------------------------- this is the section of BG-HipUp Login / Register modal
...
document.querySelector(".word").style.display = "flex";
});


//------------------------- this is the section of intant quote
...
if(service_needed_elt){
    service_needed_elt.addEventListener('change', function(evt){
        ...
        profile_elt.innerHTML = '<option value="none" selected="selected" disabled="disabled">PROFILE</option>'
...
if(service_needed_elt){
    service_needed_elt.addEventListener('change', function(evt){
        ...
        discounting_elt.innerHTML = '<option value="none" selected="selected" disabled="disabled">DISCOUNT 1</option>'
...
if(service_needed_elt){
    service_needed_elt.addEventListener('change', function(evt){
        ...
        durationData_elt.innerHTML = '<option value="none" selected="selected" disabled="disabled" id="time">DURATION</option>'
...
if(service_needed_elt){
    service_needed_elt.addEventListener('change', function(evt){
        ...
        size_data_elt.innerHTML = '<option value="none" selected="selected" disabled="disabled" id="size pages" >SIZE</option>'
...
if(service_needed_elt){
    service_needed_elt.addEventListener('change', function(evt){
        ...
        language_one_elt.innerHTML = '<option value="none" selected="selected" disabled="disabled" id="from" >FROM</option>'
...
if(service_needed_elt){
    service_needed_elt.addEventListener('change', function(evt){
        ...
        language_two_elt.innerHTML = '<option value="none" selected="selected" disabled="disabled" id="to" >TO</option>'
